...
class Genes
#The attributes wew defined and initialized. Two variables were created in order to contain
#the file information and the hash(dictionary created with the gene id and the gene name)
