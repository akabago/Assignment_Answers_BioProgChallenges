...
#Ana Karina Ballesteros Gomez, in colaboration with Angela Gomez Sacristan, Mariam El Akal Chaji y Marta Fernandez Gonzalez

class Seed
#First of all, the attributes were defined and initialized. Three variables were created in order to contain 
#the file information, the file header and the hash (dictionary created with stock id and mutant gene ID).
    attr_accessor :stock
    attr_accessor :mtgid
